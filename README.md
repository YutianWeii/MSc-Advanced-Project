...
In the context of post-humanism challenging anthropocentrism and the rapid development of AI art, the art world still lacks artworks created from non-human perspectives. Therefore, I aimed to regard AI as an audience rather than a tool, believing that an AI's dataset and model architecture constitute its "cognition." Through artistic experimentation, I designed an AI artist based on the Stable Diffusion model and three AI audiences based on CLIP and GPT models but trained with different datasets. Their interaction culminated in the AI artwork "AI Audience, Please Come In." This work represents a new endeavor in art from AI to AI, reflecting the individuality of AI under new concepts and the broader possibilities of AI art. It also expresses the desire to treat non-human entities equally.
...
Training an AI model to appreciate a specific AI artist’s style.

AI artists producing art for AI audiences.

What qualifies an AI as an artist?

Evolutionary journey: human painting → photography → computer art → AI art.

AI generating, recognizing, transforming images → inventing machines → developing an "AI's computer" → AI’s AI intelligence.
...
📅 Week 2: Read literature and continued exploring the form of the artwork. Realized AI cannot think and create entirely independently; AI audiences can’t "see" without training. My intention was to place AI on an equal footing, to see the world from their perspective, but it seems untrained models can't see at all, ending up domesticated.
Maybe accepting the "training" process is a start for exploring new art forms.

🤖️ ChatGPT’s suggestions:
...
Exploration of Meaning: Create an artwork exploring what “meaning” is to AI. Although AI lacks emotions, it can understand and analyze various patterns and structures, making this an abstract representation of “meaning”.
...
Art of Data Structures: Objective: Demonstrate how different data structures store and organize information. Implementation: Create a virtual “forest” where each “tree” represents a data structure (e.g., binary trees, red-black trees, hash tables). AI can “plant”, “prune”, or “sow” new data structures, illustrating their inner workings and pros/cons.

Algorithmic Interactive Dialogue: Objective: Facilitate “dialogue” between different AI models. Implementation: For instance, a text generation model tries to “explain” the “paintings” created by an image generation model. These models interact repeatedly, one continually generating new images, the other attempting to “interpret” them.

Model’s Self-Reflection: Objective: Allow an AI model to explore its own “thinking” process. Implementation: Provide a deep learning model with its own weights and structure as input, letting it generate an output, which can be seen as a “self-description” or “reflection” of the model.


📅 In the third week, I envisioned creating AI artists and AI audiences, interacting with their inputs and outputs to explore the final results. Here are some brainstorming ideas 🧠:
...
AI Artist —> AI Audience —> AI Audience —> AI Audience —> Output

Many AI Artists —> AI Audience (collective)
...
🤖️ I chatted with ChatGPT, and it gave me some suggestions:
...
📅 In the fourth week, I had a meeting with Adam and finalized the specific plan for my artwork.
...
Title：“From AI to AI: Exploring Automated Art in the Context of AI as both Artist and Audience” Or “From AI to AI: Delving into the New Dimension of AI as both Artist and Audience”
...
2. Background
   2.1 Literature on AI art and AI cognition. （related artworks）
...
### November 2023
📅 In the first week, I mainly completed the coding part of the artwork.
...
All images generated by the AI artist can be found in the "AI Artist’s output" folder. If you want to run this code, please open the AI artist.ipynb file.
...
The outputs of the AI audiences can be found in the "AI Audiences’ output" folder.
